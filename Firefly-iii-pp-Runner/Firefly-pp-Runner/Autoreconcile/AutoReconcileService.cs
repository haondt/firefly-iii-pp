namespace Firefly_pp_Runner.Autoreconcile
{
    public class AutoReconcileService : IAutoReconcileService
    {
        ...
        //private Func<TransactionPartDto, int> BuildHashingStrategy(
        //    bool requireMatchingDescriptions,
        //    int? dateMatchToleranceInDays)
        //{
        //    return t =>
        //    {
        //        var hc = new HashCode();
        //        hc.Add(decimal.Parse(t.Amount));
        //        if (requireMatchingDescriptions)
        //            hc.Add(t.Description);
        //        if (dateMatchToleranceInDays.HasValue && dateMatchToleranceInDays == 0)
